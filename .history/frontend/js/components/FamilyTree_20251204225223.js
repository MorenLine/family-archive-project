const FamilyTree = {
    ...
    methods: {
        ...
        getNodeColor(gender) {
            ...
            const genderStr = typeof gender === 'string'
                ? gender
        ...
        async loadPersonDetails(personId) {
            try {
                ...
                if (personData.gender) {
                    ...
                    } else if (personData.gender.toString) {
                        genderValue = personData.gender.toString();
                    } else {
                        genderValue = 'UNKNOWN';
                    }
                }
    ...
    beforeUnmount() {
        this.safeNetworkDestroy();

        // Также очистите другие ссылки
        this.treeData = null;
        this.selectedPerson = null;
        this.allPersons = [];
    },
