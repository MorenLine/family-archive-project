                                    ...
                                    <div v-for="photo in photos" 
                                        ...
                                        <div class="card photo-card" :class="{ 'border-primary': photo.isMain }">
                                            ...
                                            <div class="card-body p-2">
                                                                ...
                                                                <!-- Inline edit form для конкретного фото -->
                                                                <div v-if="editingPhotoId === photo.id" class="mt-2 p-2 border rounded bg-light">
                                                                    <div class="mb-2">
                                                                        <label class="form-label small mb-1">Название</label>
                                                                        <input v-model="editPhotoData.originalFileName" type="text" class="form-control form-control-sm">
                                                                    </div>
                                                                    <div class="mb-2">
                                                                        <label class="form-label small mb-1">Описание</label>
                                                                        <input v-model="editPhotoData.description" type="text" class="form-control form-control-sm">
                                                                    </div>
                                                                    <div class="d-flex justify-content-end">
                                                                        <button @click="savePhotoMetadata(photo.id)" class="btn btn-sm btn-success me-2">
                                                                            <i class="bi bi-check-lg"></i> Сохранить
                                                                        </button>
                                                                        <button @click="cancelEditPhoto()" class="btn btn-sm btn-outline-secondary">
