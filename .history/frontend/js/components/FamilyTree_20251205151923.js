const FamilyTree = {
    template: `
        <div class="family-tree-container">
            ...
            <div v-else id="tree-visualization-container">
                <div class="card">
    ...
    methods: {
        ...
        async buildTree() {
            ...
            try {
                ...
                // Рендерим дерево с небольшой задержкой
                setTimeout(() => {
                    this.renderTree();
                }, 100);
