const FamilyTree = {
        ...
        <div class="family-tree-container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="mb-0">
                    ...
                    <span v-if="selectedPersonInfo" class="text-muted fs-5 ms-3">
                        {{ selectedPersonInfo.fullName || selectedPersonInfo.firstName + ' ' + selectedPersonInfo.lastName }}
                    </span>
                </h1>
                <div>
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button class="btn btn-outline-success" @click="exportTree" title="Экспорт">
            ...
            <div class="row g-4">
                ...
                <div v-if="selectedPersonInfo" class="col-12">
                    <div class="card border-primary shadow-sm">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3">
                            ...
                            <div>
                                <button class="btn btn-sm btn-outline-light me-2" @click="centerOnNode(selectedPersonInfo.id)">
                                    <i class="bi bi-geo-alt me-1"></i> Найти в дереве
                                </button>
                                <router-link :to="'/persons/' + selectedPersonInfo.id" class="btn btn-sm btn-light">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="info-card">
                                                ...
                                                <div class="info-value h5 mb-0">
                                                    {{ selectedPersonInfo.lastName }} 
                                                    {{ selectedPersonInfo.firstName }} 
                                                    {{ selectedPersonInfo.middleName || '' }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="info-card">
                                                ...
                                                <div class="info-value">
                                                    <span :class="selectedPersonInfo.gender === 'MALE' ? 'badge bg-success' : 'badge bg-danger'">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="info-card">
                                                ...
                                                <div class="info-value">
                                                    <code class="text-muted">{{ selectedPersonInfo.id }}</code>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <!-- Даты жизни -->
                                        <div class="col-md-6 mb-3" v-if="selectedPersonInfo.birthDate || selectedPersonInfo.deathDate">
                                            <div class="info-card">
                                                <div class="info-label">Даты жизни</div>
                                                <div class="info-value">
                                                    <div v-if="selectedPersonInfo.birthDate">
                                                        <i class="bi bi-calendar-plus text-success me-2"></i>
                                                        Родился: {{ formatDate(selectedPersonInfo.birthDate) }}
                                                    </div>
                                                    <div v-if="selectedPersonInfo.deathDate" class="mt-1">
                                                        <i class="bi bi-calendar-x text-danger me-2"></i>
                                                        Умер: {{ formatDate(selectedPersonInfo.deathDate) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Возраст -->
                                        <div class="col-md-3 mb-3" v-if="selectedPersonInfo.birthDate">
                                            <div class="info-card">
                                                <div class="info-label">Возраст</div>
                                                <div class="info-value">
                                                    <span class="badge bg-info">
                                                        {{ calculateAge(selectedPersonInfo.birthDate, selectedPersonInfo.deathDate) }} лет
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="info-card">
                                                ...
                                                <div class="info-value">
                                                    <span :class="selectedPersonInfo.deathDate ? 'badge bg-secondary' : 'badge bg-success'">
                                                        {{ selectedPersonInfo.deathDate ? 'Умер' : 'Жив' }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="family-connections">
                                        <!-- Родители -->
                                        <div v-if="selectedPersonInfo.parents && selectedPersonInfo.parents.length > 0" class="mb-4">
                                            <h6 class="border-bottom pb-2 mb-3">
                                                <i class="bi bi-arrow-up-circle me-2"></i>Родители
                                            </h6>
                                            <div class="list-group">
                                                <div v-for="parent in selectedPersonInfo.parents" :key="parent.id" 
                                        ...
                                        <!-- Дети -->
                                        <div v-if="selectedPersonInfo.children && selectedPersonInfo.children.length > 0">
                                            <h6 class="border-bottom pb-2 mb-3">
                                                <i class="bi bi-arrow-down-circle me-2"></i>Дети
                                                <span class="badge bg-light text-dark ms-2">{{ selectedPersonInfo.children.length }}</span>
                                            </h6>
                                            <div class="list-group">
                                                <div v-for="child in selectedPersonInfo.children" :key="child.id" 
                                                     class="list-group-item list-group-item-action d-flex align-items-center"
                                        ...
                                        <!-- Нет связей -->
                                        <div v-if="(!selectedPersonInfo.parents || selectedPersonInfo.parents.length === 0) && 
                                                  (!selectedPersonInfo.children || selectedPersonInfo.children.length === 0)" 
    ...
    data() {
        return {
            ...
            showLegend: true,
            treeHeight: 600,
            nodeConnections: new Map() // Хранит связи узлов
        }
    },

    async mounted() {
        // Устанавливаем высоту дерева в зависимости от высоты окна
    ...
    methods: {
        ...
        async loadAllPersons() {
            try {
                ...
                // Создаем карту для быстрого доступа к данным персон
                this.allPersonsMap = new Map(
                    this.allPersons.map(p => [p.id, p])
                );
            } catch (error) {
        ...
        async loadTree() {
            ...
            try {
                ...
                // Загружаем информацию о корневой персоне
        ...
        async createNetwork() {
            ...
            try {
                ...
                const nodes = new vis.DataSet(this.treeData.nodes.map(node => {
                    ...
                    // Форматируем метку
                    let label = `<b>${node.data?.firstName || ''} ${node.data?.lastName || ''}</b>`;
                    ...
                    processedNode.margin = 12;
                    processedNode.widthConstraint = { minimum: 120, maximum: 180 };
                    processedNode.heightConstraint = { minimum: 60 };
                ...
                const options = {
                    ...
                    nodes: {
                        // Настройки уже применены к каждому узлу
                    },
                    edges: {
                        // Настройки уже применены к каждой связи
                    }
                };
                ...
                // Подгоняем под экран с анимацией
                setTimeout(() => {
                    this.fitToScreen();
                }, 500);
        ...
        async loadPersonInfo(personId) {
            try {
                // Загружаем основную информацию о персоне
                ...
                if (person.parent1) {
                    parents.push({
                        id: person.parent1.id,
                        fullName: person.parent1.firstName + ' ' + person.parent1.lastName,
                        gender: person.parent1.gender,
                        birthDate: person.parent1.birthDate,
                        deathDate: person.parent1.deathDate
                    });
                }
                if (person.parent2) {
                    parents.push({
                        id: person.parent2.id,
                        fullName: person.parent2.firstName + ' ' + person.parent2.lastName,
                        gender: person.parent2.gender,
                        birthDate: person.parent2.birthDate,
                        deathDate: person.parent2.deathDate
                    });
                }
        ...
        exportTree() {
            ...
            try {
                const dataUrl = this.network.toBase64('image/png', 2.0);
                if (dataUrl) {
                    const link = document.createElement('a');
                    link.download = `семейное-дерево-${new Date().toISOString().slice(0, 10)}.png`;
                    link.href = dataUrl;
                    link.click();
                }
            } catch (error) {
