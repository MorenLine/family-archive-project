                                ...
                                <div class="row g-2">
                                    <div v-for="photo in photos" 
                                        ...
                                        <div class="card photo-card" :class="{ 'border-primary': photo.isMain }">
                                            <div class="card-body d-flex align-items-center p-2" style="gap:0.75rem;">
                                                <!-- ЛЕВАЯ ЧАСТЬ: метаданные -->
                                                <div class="photo-meta" style="flex:1;min-width:0;">
                                                    <small class="text-muted d-block">
                                                        {{ photo.photoDate ? formatDate(photo.photoDate) : 'Без даты' }}
                                                    </small>
                                                    <div class="fw-semibold text-truncate" style="max-width:100%;">{{ photo.originalFileName || 'Без названия' }}</div>
                                                    <div class="text-truncate text-muted" style="max-width:100%;">{{ photo.description || '' }}</div>

                                                    <!-- Кнопки действий под данными -->
                                                    <div class="mt-2">
                                                ...
                                                <!-- ПРАВАЯ ЧАСТЬ: превью фото -->
                                                <div class="photo-thumb" style="width:140px;flex-shrink:0;display:flex;align-items:center;justify-content:center;">
                                                    <div class="position-relative" style="width:100%;text-align:center;">
                                                        <img :src="getPhotoUrl(photo.fileName)" 
                                                             :alt="photo.description"
                                                             class="img-fluid rounded"
                                                             style="max-width:100%;max-height:120px;object-fit:cover;display:block;margin:0 auto;" />
                                                        <div v-if="photo.isMain" class="main-photo-badge" style="position:absolute;left:6px;top:6px;">
                                                            <i class="bi bi-star-fill"></i>
                                                        </div>
                                                    </div>
                                                </div>
