    ...
    methods: {
        ...
        async submitForm() {
            ...
            try {
                ...
                // Подготавливаем данные для отправки: преобразуем parent1Id/parent2Id в объекты
                const personData = {
                    ...this.person,
                    parent1: this.person.parent1Id ? { id: this.person.parent1Id } : null,
                    parent2: this.person.parent2Id ? { id: this.person.parent2Id } : null
                };
                // Удаляем поля parent1Id/parent2Id, так как они не нужны
                delete personData.parent1Id;
                delete personData.parent2Id;
