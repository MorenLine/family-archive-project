...
public class PersonApiController {
    ...
    private Map<String, Object> createSimpleNode(Person person) {
        ...
        tooltip.append("<div style='padding:8px;max-width:250px;text-align:left;font-family:Arial;'>");
        tooltip.append("<strong style='font-size:14px;'>").append(person.getFullName()).append("</strong><br/>");

        if (person.getBirthDate() != null) {
            tooltip.append("<span style='color:#666;font-size:12px;'>Родился: ").append(person.getBirthDate())
                    .append("</span><br/>");
        }

        if (person.getDeathDate() != null) {
            tooltip.append("<span style='color:#666;font-size:12px;'>Умер: ").append(person.getDeathDate())
                    .append("</span><br/>");
        }

        if (person.getGender() != null) {
            tooltip.append("<span style='color:#666;font-size:12px;'>Пол: ");
        ...
        node.put("font", Map.of("size", 12, "multi", true));
