...
public class PersonApiController {
    ...
    ПОЛНАЯ ИНФОРМАЦИЯ
    О ДЕРЕВЕ===FamilyTree.js:583 Узлы:3 FamilyTree.js:584 Связи:2 FamilyTree.js:587---
    ДЕТАЛИ СВЯЗЕЙ---FamilyTree.js:591 Связь 1:FamilyTree.js:592 От:

    Мама мама (8)
FamilyTree.js:593   К:

    Я Я (7)
FamilyTree.js:594   Тип: Женский → Мужской
FamilyTree.js:591 Связь 2:
FamilyTree.js:592   От:
