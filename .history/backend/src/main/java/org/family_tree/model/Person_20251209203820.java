...
public class Person {
    ...
    @JoinTable(name = "marriage", joinColumns = @JoinColumn(name = "person1_id"), inverseJoinColumns = @JoinColumn(name = "person2_id"))
    @JsonIgnoreProperties({ "hibernateLazyInitializer", "handler", "spouses" })
    ...
    @Transient
    @JsonIgnore
    private List<Marriage> allMarriages = new ArrayList<>();
